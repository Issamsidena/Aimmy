...
namespace Aimmy2.AILogic
{
    internal class AIManager : IDisposable
    {
        ...
        public static Action<int> ImageSizeUpdated { get; internal set; }
        ...
        private Prediction? HandleStickyAim(Prediction? bestCandidate, List<Prediction> predictions)
        {
            ...
            if (bestCandidate == null || predictions == null || predictions.Count == 0)
            {
