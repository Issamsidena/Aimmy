    ...
    internal class DdxoftMain
    {
        ...
        public static async Task<bool> DLLLoading()
        {
            try
            {
                ...
                {
                    MessageBox.Show("The ddxoft Virtual Input Driver requires Vector to be run as an administrator, please close Vector and run it as administrator to use this movement method.", "Vector");
                    return false;
                }
                ...
                {
                    MessageBox.Show("The ddxoft virtual input driver is not compatible with your PC, please try a different Mouse Movement Method.", "Vector");
                    return false;
                }
