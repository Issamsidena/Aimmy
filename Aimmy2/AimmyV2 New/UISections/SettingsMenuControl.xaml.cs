    ...
    public partial class SettingsMenuControl : UserControl
    {
        ...
        private void LoadModelSettings()
        {
            ...
            builder
                ...
                {
                    uiManager.D_ExecutionProvider = d;
                ...
                .AddSlider("AI Minimum Confidence", "% Confidence", 1, 1, 1, 100, s =>
                {
                    ...
                    s.Slider.PreviewMouseLeftButtonUp += (sender, e) =>
                    {
                        ...
                        if (value >= 95)
                            LogManager.Log(LogLevel.Warning, "The minimum confidence you have set for Vector to be too high and may be unable to detect players.", true);
                        else if (value <= 35)
                            LogManager.Log(LogLevel.Warning, "The minimum confidence you have set for Vector may be too low can cause false positives.", true);
                    };
